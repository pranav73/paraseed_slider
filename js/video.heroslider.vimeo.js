/**
 * @file
 * Behaviors of paraseed hero slider media for vimeo embeded videos scripts.
 */

(function ($, Drupal) {
  "use strict";

  Drupal.behaviors.paraseedHeroSliderMedia_vimeo = {
    attach: function (context, settings) {
      ...
      mediaSliders.on('beforeChange', function (event, slick, currentSlide, nextSlide) {
        var currentVideo = $('.slide--' + currentSlide + '.slick-active').find('.paraseed-video-player iframe[src*="vimeo.com"]', context);
      ...
      mediaSliders.each(function(i) {
        var firstIframeVideo = $(this).find('.slide').first().find('.paraseed-video-player iframe[src*="vimeo.com"]', context);
